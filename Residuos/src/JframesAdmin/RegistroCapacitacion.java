...
public class RegistroCapacitacion extends javax.swing.JFrame {
    ...
    public RegistroCapacitacion() {
        ...
        setTitle("Registrar Capacitaciones");
        setResizable(false);
        Image icono = new ImageIcon(getClass().getResource("/iconosAdmin/Users-icon.png")).getImage();
        setIconImage(icono);
    }

    public boolean verificarVacios() {
        if ((jTextField5.getText().equals("")) || (jTextArea1.getText().equals(""))
                || jTextField4.getText().equals("") || (jTextField6.equals(""))) {
            return true;
        }
        return false;
    }
    ...
    public void insertar() {
        ...
        if (verificarVacios()) {
            ...
            gc.setNombre(jTextField5.getText());
            gc.setDireccion(jTextArea1.getText());
            gc.setHora(jTextField4.getText());
            gc.setFecha(jTextField6.getText());
            gc.setCupo(Integer.parseInt(jSpinner2.getValue().toString()));
            if (gc.existe()) {
